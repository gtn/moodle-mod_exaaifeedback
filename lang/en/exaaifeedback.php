...
$string['notification_settings'] = 'Notification';
$string['notification_custom'] = 'Use custom notification text';
$string['notification_custom:desc'] = 'If enabled, the subject and message below replace the default notification text. Available placeholders: {feedbackurl} (direct link to the participant\'s feedback document), {user.firstname}, {user.lastname}, {user.fullname}.';
$string['notification_subject'] = 'Email subject';
$string['notification_body'] = 'Email message';
