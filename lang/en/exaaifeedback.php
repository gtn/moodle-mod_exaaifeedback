...
$string['notification_subject'] = 'Your feedback for "{$a}" is available';
$string['notification_body'] = 'Your feedback for "{$a}" has been released and is now available for you to view.';
